...
decoupling mailboxes from processing actors. We propose modelling mailboxes as
...
scalability. We formally specify the message-passing mechanism and operational
semantics for this decoupled architecture. The design addresses challenges in
message flow management under high volumes while maintaining a clear separation
of concerns. Although the approach may introduce additional system complexity
and latency, we believe the benefits in terms of flexibility, scalability, and
maintainability of actor-based systems are worth the possible trade-offs.
}
